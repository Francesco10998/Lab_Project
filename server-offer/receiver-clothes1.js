...
amqp.connect('amqp://rabbit:5672', (err, connection) => {
    ...
    connection.createChannel((err, channel) => {
        ...
        let routingKey = 'Clothes'; // Chiave di instradamento per uno specifico worker

        channel.assertExchange(exchangeName, 'direct', {
            durable: false
        });

        channel.assertQueue('Clothes', {
            exclusive: false
        }, (err, q) => {
            if (err) {
                throw err;
            ...
            channel.consume(q.queue, (msg) => {
                ...
                // aggiorna i valori di bet e currenwinner nella tabella auctions
