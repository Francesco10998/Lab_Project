      ...
      <div id="auction-container">
          <div class="auction-item">
            ...
            <div class="item-details">
              <h3 class="objectOffers">Iphone</h3>
              <p class="betOffers">Leading Offer: $250</p>
              <p class="winnerOffers">Current Winner: Fede11</p>
              <p class="deadlineOffers">Ends in 7 hrs</p>
            </div>
          </div>
      </div>   
    )
